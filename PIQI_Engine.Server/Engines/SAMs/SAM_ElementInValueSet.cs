...
namespace PIQI_Engine.Server.Engines.SAMs
{
    ...
    /// is a member of a specified value set.
    /// </summary>
    public class SAM_ElementInValueSet : SAMBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SAM_ElementInValueSet"/> class.
        /// </summary>
        /// <param name="sam">The SAM object associated with this evaluator.</param>
        /// <param name="samService">
        /// An implementation of <see cref="SAMService"/> used to access reference data and make FHIR API calls.
        /// </param>
        public SAM_ElementInValueSet(SAM sam, SAMService samService) : base(sam, samService) { }

        /// <summary>
        /// Evaluates whether the element's primary concept exists within the specified value set.
        /// </summary>
        /// <param name="request">
        ...
        /// Returns a passed result if the primary concept is found in the specified value set,
        /// a failed result if it is not found or invalid,
        ...
        /// The evaluation passes when at least one valid coding in the primary concept
        /// matches a coding in the specified value set.
        /// </para>
        ...
        public override async Task<PIQISAMResponse> EvaluateAsync(PIQISAMRequest request)
        {
            ...
            { 
                ...
                if (primaryConceptRole == null) 
                    return result.Skip("Missing primary concept role in data class.");
                ...
                if (string.IsNullOrWhiteSpace(setMnemonic)) 
                    return result.Skip("Parameter [Value Set Mnemonic] was not supplied");
                ...
                if (data == null || string.IsNullOrEmpty(data.Text)) 
                    return result.Skip("Primary concept data is missing or empty.");  
                ...
                if (!codeableConcept.CodingList.Any(c => c.IsComplete == true)) 
                    return result.Skip("Primary concept data is has no complete codings.");
                ...
                if (!codeableConcept.CodingList.Any(t => t.IsValid)) 
                    return result.Skip("No valid codings found in the primary concept.");
        ...
        /// </summary>
        public static string StaticMnemonic => "ELEMENT_PRIM_CONCEPT_IN_VALUESET";
        /// <summary>
