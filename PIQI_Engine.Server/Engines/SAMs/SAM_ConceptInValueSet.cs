...
namespace PIQI_Engine.Server.Engines.SAMs
{
    ...
    /// </summary>
    public class SAM_ConceptInValueSet : SAMBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SAM_ConceptInValueSet"/> class.
        /// </summary>
        ...
        /// </param>
        public SAM_ConceptInValueSet(SAM sam, SAMService samService) : base(sam, samService) { }
        ...
        /// </summary>
        public static string StaticMnemonic => "CONCEPT_INVALUESET";
        /// <summary>
